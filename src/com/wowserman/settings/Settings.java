...
public class Settings {
	...
	private static boolean caseSensitive = false, debug = false, ignoreNicknames = false, stats = false, autoUpdate = false;
	...
	private static List<String> playerOnClick = new ArrayList<String>(), playerOnHover = new ArrayList<String>(), urlOnHover = new ArrayList<String>();
	...
	/**
	 * @param section The Section of a Configuration File that is being read.
